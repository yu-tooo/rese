<div class="bg-white mx-auto w-96 shadow-lg p-4 rounded-b-md text-right">
  <div class="flex items-center border-b">
    <x-icons.user />
    <input type="text" name="name" class="w-full border-none focus:ring-0" placeholder="Name">
  </div>
  <p class="text-sm text-red-500 text-center">{{ $errors->first('name') }}</p>
  ...
  <button class="mt-4 px-4 py-0.5 bg-blue-600 text-white rounded-md shadow-md">登録</button>
</div>
<x-layout>
  ...
  <div class="md:flex justify-between">
    ...
    <div class="bg-blue-600 rounded-md pt-4 md:w-5/12 h-fit">
      ...
      @endif
      <form method="POST" action="{{ route('owner.detail', ['id' => $restaurant->id]) }}" enctype="multipart/form-data">
        @csrf
        ...
        <div x-data="{ imagePreview: null }" class="flex items-center justify-center relative bg-gray-100 h-36 ml-4 w-11/12 rounded-md mt-4">
